...
int main() {
    ...
    printf("\nLa person la plus petite est: %s %s, age: %d\n",people[youngest(people, 12)].name, 
                                                              people[youngest(people, 12)].lastName,
                                                              people[youngest(people, 12)].age);

    printf("\nLa person la plus grande est: %s %s, age: %d\n",people[oldest(people, 12)].name,
                                                              people[oldest(people, 12)].lastName,
                                                              people[oldest(people, 12)].age);
